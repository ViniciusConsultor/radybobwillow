...
//            query.AddScalar("iUsefullifeunitclsdesc", NHibernateUtil.String);
        ...
        private StringBuilder CreateSelectSQL(SearchCondition condition)
        {
            ...
            sql.AppendLine(" T_PM_MS_ADD_RTCM.I_ZKTIKZTICD4 iZktikzticd4, ");//品目情報追加RTCM
            ...
            sql.AppendLine(" VTL_DESC_04.I_CLS_DETAIL_DESC vItemtype3desc, ");//品目分類3名
            ...
            sql.Append("           AND VTL_CLS_01.I_LANGUAGE_CD = ").Append(":langCd").AppendLine(")");
            ...
            //-------[2.0.0906.0801] 2009.06.08 Fsol)imatomi add str
            sql.Append("           AND VTL_CLS_02.I_LANGUAGE_CD = ").Append(":langCd").AppendLine(")");
            //-------[2.0.0906.0801] 2009.06.08 Fsol)imatomi add end
            ...
            //-------[2.0.0906.0801] 2009.06.08 Fsol)imatomi add str
            sql.Append("           AND VTL_CLS_03.I_LANGUAGE_CD = ").Append(":langCd").AppendLine(")");
            //-------[2.0.0906.0801] 2009.06.08 Fsol)imatomi add end
            ...
            //-------[2.0.0906.0801] 2009.06.08 Fsol)imatomi add str
            sql.Append("           AND VTL_CLS_04.I_LANGUAGE_CD = ").Append(":langCd").AppendLine(")");
            //-------[2.0.0906.0801] 2009.06.08 Fsol)imatomi add end
            ...
            //-------[2.0.0906.0801] 2009.06.08 Fsol)imatomi add str
            sql.Append("           AND VTL_CLS_05.I_LANGUAGE_CD = ").Append(":langCd").AppendLine(")");
            //-------[2.0.0906.0801] 2009.06.08 Fsol)imatomi add end
            ...
            //-------[2.0.0906.0801] 2009.06.08 Fsol)imatomi add str
            sql.Append("           AND VTL_CLS_06.I_LANGUAGE_CD = ").Append(":langCd").AppendLine(")");
            //-------[2.0.0906.0801] 2009.06.08 Fsol)imatomi add end
            ...
            //-------[2.0.0906.0801] 2009.06.08 Fsol)imatomi add str
            sql.Append("           AND VTL_CLS_07.I_LANGUAGE_CD = ").Append(":langCd").AppendLine(")");
            //-------[2.0.0906.0801] 2009.06.08 Fsol)imatomi add end
            ...
            //-------[2.0.0906.0801] 2009.06.08 Fsol)imatomi add str
            sql.Append("           AND VTL_CLS_08.I_LANGUAGE_CD = ").Append(":langCd").AppendLine(")");
            //-------[2.0.0906.0801] 2009.06.08 Fsol)imatomi add end
            ...
            //-------[2.0.0906.0801] 2009.06.08 Fsol)imatomi add str
            sql.Append("           AND VTL_CLS_09.I_LANGUAGE_CD = ").Append(":langCd").AppendLine(")");
            //-------[2.0.0906.0801] 2009.06.08 Fsol)imatomi add end
            ...
            //-------[2.0.0906.0801] 2009.06.08 Fsol)imatomi add str
            sql.Append("           AND VTL_CLS_10.I_LANGUAGE_CD = ").Append(":langCd").AppendLine(")");
            //-------[2.0.0906.0801] 2009.06.08 Fsol)imatomi add end
            ...
            //-------[2.0.0906.0801] 2009.06.08 Fsol)imatomi add str
            sql.Append("           AND VTL_CLS_11.I_LANGUAGE_CD = ").Append(":langCd").AppendLine(")");
            //-------[2.0.0906.0801] 2009.06.08 Fsol)imatomi add end
            ...
            //-------[2.0.0906.0801] 2009.06.08 Fsol)imatomi add str
            sql.Append("           AND VTL_CLS_12.I_LANGUAGE_CD = ").Append(":langCd").AppendLine(")");
            //-------[2.0.0906.0801] 2009.06.08 Fsol)imatomi add end
            ...
            //-------[2.0.0906.0801] 2009.06.08 Fsol)imatomi add str
            sql.Append("           AND VTL_CLS_13.I_LANGUAGE_CD = ").Append(":langCd").AppendLine(")");
            //-------[2.0.0906.0801] 2009.06.08 Fsol)imatomi add end
            ...
            //-------[2.0.0906.0801] 2009.06.08 Fsol)imatomi add str
            sql.Append("           AND VTL_CLS_14.I_LANGUAGE_CD = ").Append(":langCd").AppendLine(")");
            //-------[2.0.0906.0801] 2009.06.08 Fsol)imatomi add end
            ...
            //-------[2.0.0906.0801] 2009.06.08 Fsol)imatomi add str
            sql.Append("           AND VTL_CLS_15.I_LANGUAGE_CD = ").Append(":langCd").AppendLine(")");
            //-------[2.0.0906.0801] 2009.06.08 Fsol)imatomi add end
            ...
            //-------[2.0.0906.0801] 2009.06.08 Fsol)imatomi add str
            sql.Append("           AND VTL_CLS_16.I_LANGUAGE_CD = ").Append(":langCd").AppendLine(")");
            //-------[2.0.0906.0801] 2009.06.08 Fsol)imatomi add end
            ...
            //-------[2.0.0906.0801] 2009.06.08 Fsol)imatomi add str
            sql.Append("           AND VTL_CLS_17.I_LANGUAGE_CD = ").Append(":langCd").AppendLine(")");
            //-------[2.0.0906.0801] 2009.06.08 Fsol)imatomi add end
            ...
            //-------[2.0.0906.0801] 2009.06.08 Fsol)imatomi add str
            sql.Append("           AND VTL_CLS_18.I_LANGUAGE_CD = ").Append(":langCd").AppendLine(")");
            //-------[2.0.0906.0801] 2009.06.08 Fsol)imatomi add end
            ...
            //-------[2.0.0906.0801] 2009.06.08 Fsol)imatomi add str
            sql.Append("           AND VTL_CLS_19.I_LANGUAGE_CD = ").Append(":langCd").AppendLine(")");
            //-------[2.0.0906.0801] 2009.06.08 Fsol)imatomi add end
            ...
            //-------[2.0.0906.0801] 2009.06.08 Fsol)imatomi add str
            sql.Append("           AND VTL_CLS_20.I_LANGUAGE_CD = ").Append(":langCd").AppendLine(")");
            //-------[2.0.0906.0801] 2009.06.08 Fsol)imatomi add end
            ...
            //-------[2.0.0906.0801] 2009.06.08 Fsol)imatomi add str
            sql.Append("           AND VTL_CLS_21.I_LANGUAGE_CD = ").Append(":langCd").AppendLine(")");
            //-------[2.0.0906.0801] 2009.06.08 Fsol)imatomi add end
            ...
            //-------[2.0.0906.0801] 2009.06.08 Fsol)imatomi add str
            sql.Append("           AND VTL_CLS_22.I_LANGUAGE_CD = ").Append(":langCd").AppendLine(")");
            //-------[2.0.0906.0801] 2009.06.08 Fsol)imatomi add end
            ...
            //-------[2.0.0906.0801] 2009.06.08 Fsol)imatomi add str
            sql.Append("           AND VTL_CLS_23.I_LANGUAGE_CD = ").Append(":langCd").AppendLine(")");
            //-------[2.0.0906.0801] 2009.06.08 Fsol)imatomi add end
            ...
            //-------[2.0.0906.0801] 2009.06.08 Fsol)imatomi add str
            sql.Append("           AND VTL_CLS_24.I_LANGUAGE_CD = ").Append(":langCd").AppendLine(")");
            //-------[2.0.0906.0801] 2009.06.08 Fsol)imatomi add end
            ...
            //-------[2.0.0906.0801] 2009.06.08 Fsol)imatomi add str
            sql.Append("           AND VTL_CLS_25.I_LANGUAGE_CD = ").Append(":langCd").AppendLine(")");
            //-------[2.0.0906.0801] 2009.06.08 Fsol)imatomi add end
            ...
            //-------[2.0.0906.0801] 2009.06.08 Fsol)imatomi add str
            sql.Append("           AND VTL_CLS_26.I_LANGUAGE_CD = ").Append(":langCd").AppendLine(")");
            //-------[2.0.0906.0801] 2009.06.08 Fsol)imatomi add end
            ...
            //-------[2.0.0906.0801] 2009.06.08 Fsol)imatomi add str
            sql.Append("           AND VTL_DESC_01.I_LANGUAGE_CD = ").Append(":langCd").AppendLine(")");
            //-------[2.0.0906.0801] 2009.06.08 Fsol)imatomi add end
            ...
            //-------[2.0.0906.0801] 2009.06.08 Fsol)imatomi add str
            sql.Append("           AND VTL_DESC_02.I_LANGUAGE_CD = ").Append(":langCd").AppendLine(")");
            //-------[2.0.0906.0801] 2009.06.08 Fsol)imatomi add end
            ...
            //-------[2.0.0906.0801] 2009.06.08 Fsol)imatomi add str
            //sql.Append("           AND VTL_DESC_03.I_LANGUAGE_CD = ").Append(":langCd").AppendLine(")");
            //-------[2.0.0906.0801] 2009.06.08 Fsol)imatomi add end
            ...
            //-------[2.0.0906.0801] 2009.06.08 Fsol)imatomi add str
            sql.Append("           AND VTL_DESC_04.I_LANGUAGE_CD = ").Append(":langCd").AppendLine(")");
            //-------[2.0.0906.0801] 2009.06.08 Fsol)imatomi add end
            ...
            //-------[2.0.0906.0801] 2009.06.08 Fsol)imatomi add str
            sql.Append("           AND VTL_DESC_05.I_LANGUAGE_CD = ").Append(":langCd").AppendLine(")");
            //-------[2.0.0906.0801] 2009.06.08 Fsol)imatomi add end
            ...
            //-------[2.0.0906.0801] 2009.06.08 Fsol)imatomi add str
            sql.Append("           AND VTL_DESC_06.I_LANGUAGE_CD = ").Append(":langCd").AppendLine(")");
            //-------[2.0.0906.0801] 2009.06.08 Fsol)imatomi add end
            ...
            ////-------[2.0.0906.0801] 2009.06.08 Fsol)imatomi add str
            //sql.Append("           AND VTL_DESC_07.I_LANGUAGE_CD = ").Append(":langCd").AppendLine(")");
            ////-------[2.0.0906.0801] 2009.06.08 Fsol)imatomi add end
            //-------[2.0.0907.1101] 2009.07.11 Fsol)imatomi del end
            ...
            //-------[2.0.0906.0801] 2009.06.08 Fsol)imatomi add str
            sql.Append("           AND VTL_DESC_08.I_LANGUAGE_CD = ").Append(":langCd").AppendLine(")");
            //-------[2.0.0906.0801] 2009.06.08 Fsol)imatomi add end
            ...
            //-------[2.0.0906.0801] 2009.06.08 Fsol)imatomi add str
            sql.Append("           AND VTL_DESC_09.I_LANGUAGE_CD = ").Append(":langCd").AppendLine(")");
            //-------[2.0.0906.0801] 2009.06.08 Fsol)imatomi add end
            ...
            //-------[2.0.0906.0801] 2009.06.08 Fsol)imatomi add str
            sql.Append("           AND VTL_DESC_10.I_LANGUAGE_CD = ").Append(":langCd").AppendLine(")");
            //-------[2.0.0906.0801] 2009.06.08 Fsol)imatomi add end
            ...
            //-------[2.0.0906.0801] 2009.06.08 Fsol)imatomi add str
            sql.Append("           AND VTL_DESC_11.I_LANGUAGE_CD = ").Append(":langCd").AppendLine(")");
            //-------[2.0.0906.0801] 2009.06.08 Fsol)imatomi add end
            ...
            //-------[2.0.0906.0801] 2009.06.08 Fsol)imatomi add str
            sql.Append("           AND VTL_DESC_12.I_LANGUAGE_CD = ").Append(":langCd").AppendLine(")");
            //-------[2.0.0906.0801] 2009.06.08 Fsol)imatomi add end
            ...
            //-------[2.0.0906.0801] 2009.06.08 Fsol)imatomi add str
            sql.Append("           AND VTL_DESC_13.I_LANGUAGE_CD = ").Append(":langCd").AppendLine(")");
            //-------[2.0.0906.0801] 2009.06.08 Fsol)imatomi add end
            ...
            //-------[2.0.0906.0801] 2009.06.08 Fsol)imatomi add str
            sql.Append("           AND VTL_DESC_14.I_LANGUAGE_CD = ").Append(":langCd").AppendLine(")");
            //-------[2.0.0906.0801] 2009.06.08 Fsol)imatomi add end
            ...
            //-------[2.0.0906.0801] 2009.06.08 Fsol)imatomi add str
            sql.Append("           AND VTL_DESC_15.I_LANGUAGE_CD = ").Append(":langCd").AppendLine(")");
            //-------[2.0.0906.0801] 2009.06.08 Fsol)imatomi add end
            ...
            //-------[2.0.0906.0801] 2009.06.08 Fsol)imatomi add str
            sql.Append("           AND VTL_DESC_16.I_LANGUAGE_CD = ").Append(":langCd").AppendLine(")");
            //-------[2.0.0906.0801] 2009.06.08 Fsol)imatomi add end
            ...
            //-------[2.0.0906.0801] 2009.06.08 Fsol)imatomi add str
            sql.Append("           AND VTL_DESC_17.I_LANGUAGE_CD = ").Append(":langCd").AppendLine(")");
            //-------[2.0.0906.0801] 2009.06.08 Fsol)imatomi add end
            ...
            sql.Append("           AND VTL_CLS_27.I_LANGUAGE_CD = ").Append(":langCd").AppendLine(")");
            //定期保守期間単位
            ...
            sql.Append("           AND VTL_CLS_28.I_LANGUAGE_CD = ").Append(":langCd").AppendLine(")");
            //保証期間単位
            ...
            sql.Append("           AND VTL_CLS_29.I_LANGUAGE_CD = ").Append(":langCd").AppendLine(")");
            //保守区分
            ...
            sql.Append("           AND VTL_CLS_30.I_LANGUAGE_CD = ").Append(":langCd").AppendLine(")");
            //号機採番要否区分
            ...
            sql.Append("           AND VTL_CLS_31.I_LANGUAGE_CD = ").Append(":langCd").AppendLine(")");
            //耐用寿命単位区分
            ...
            sql.Append("           AND VTL_CLS_32.I_LANGUAGE_CD = ").Append(":langCd").AppendLine(")");
            //-------[3.0.0908.0601] 2009.07.08 Fns)k.ito add end 【V3(保守管理)対応】
            //------------------------------------------------------------------------------------------------------------------------------------
            ...
            bool allFactory = (bool)condition.GetAddtionalCondition("ALLFACTORY");
            if (allFactory)
            {
