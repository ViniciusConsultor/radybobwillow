...
namespace Com.GainWinSoft.ERP.Entity.Dao.StoredInfo
{
	...
	/// ストアド論理名：ストアド工場条件情報設定
	/// </summary>
	[Serializable]
	public sealed class STORED_PE0022P : IStoredParameterInfo
	{
		...
		/// ストアド名
		/// </summary>
		public static readonly string STORED_NAME = "PE0022P.TOP_RTN";
		...
		#region コンストラクタ
			...
			public STORED_PE0022P()
			{
                ...
                this._i_fac_cd = new ParameterInfo("i_fac_cd", 8, ParameterDirection.Input, DbType.String, false, 0);
		...
		/// パラメータ 「工場番号」
		/// </summary>
		private ParameterInfo _i_fac_cd = null;
		...
		/// 出力タイプ : Input
		/// </summary>
		public ParameterInfo I_fac_cd
		{
			get
			{
				return this._i_fac_cd;
			}
		}
