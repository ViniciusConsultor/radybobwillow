...
namespace Com.GainWinSoft.Common.Control.XAccordionPanel
{
    ...
    public class BseRenderer : ToolStripProfessionalRenderer
    {
        ...
        /// </summary>
        public BseRenderer()
            : base(new Com.GainWinSoft.Common.Control.XAccordionPanel.ColorTableBlack())
        {
        ...
        /// </summary>
        /// <param name="professionalColorTable">A <see cref="Com.GainWinSoft.Common.Control.XAccordionPanel.ProfessionalColorTable"/> to be used for painting.</param>
        ...
        protected override void OnRenderArrow(ToolStripArrowRenderEventArgs e)
        {
            ...
            {
                ProfessionalColorTable colorTable = ColorTable as Com.GainWinSoft.Common.Control.XAccordionPanel.ProfessionalColorTable;
